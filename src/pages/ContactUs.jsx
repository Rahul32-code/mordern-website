  ...
  return (
    ...
    >
      ...
      >
        {/* Name Field */}
        <div>
          <p className="mb-2 text-sm font-medium dark:text-gray-600">Your Name</p>
        ...
        {/* Email Field */}
        <div>
          <p className="mb-2 text-sm font-medium dark:text-gray-600">Email Id</p>
          <div className="flex pl-3 rounded-lg border border-gray-300 dark:border-gray-600">
        ...
        >
          ...
          {!isLoading && <img src={assets.arrow_icon} alt="arrow" className="w-4" />}
        </button>
      </form>
    </div>
  );
